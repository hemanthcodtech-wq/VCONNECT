    ...
    <div className="min-h-screen bg-[#FDF8F0] pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        {wishlistProducts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 md:py-32 bg-white rounded-3xl shadow-sm border border-brand-blue/10 text-center px-4">
            ...
            <Link to="/category/all" className="bg-brand-blue text-white px-8 py-3 rounded-full font-bold text-sm hover:bg-brand-orange text-white hover:shadow-lg transition-all hover:scale-105 inline-flex items-center justify-center">
              Discover Products
            </Link>
          </div>
        ) : (
