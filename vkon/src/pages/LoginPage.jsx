...
function ForgotPassword({ onBack, dark = false }) {
  ...
  const inputCls = dark
    ...
    : 'w-full bg-white border border-gray-200 shadow-inner rounded-xl px-4 pl-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#0033a0] focus:ring-4 focus:ring-[#0033a0]/10 focus:bg-white hover:border-gray-300 transition-all duration-300 shadow-sm';
  ...
  const btnCls = dark
    ...
    : 'w-full bg-gradient-to-r from-[#0033a0] to-[#15803d] text-white font-bold py-3.5 rounded-xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:hover:translate-y-0 shadow-md';
  const errCls = dark
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <h4 className={`font-bold tracking-widest uppercase text-xs mb-1 ${dark ? 'text-brand-orange' : 'text-brand-blue'}`}>Reset Password</h4>
            ...
            {otp.map((digit, idx) => (
              <input key={idx} ref={el => otpRefs.current[idx] = el}
                ...
                className={`w-10 h-12 text-center text-xl font-bold rounded-xl border-2 focus:outline-none transition-colors ${
                  dark ? 'bg-transparent border-white/20 text-white focus:border-[#D4AF37]' : 'bg-white border-brand-blue/10 text-gray-900 focus:border-brand-blue/10'
                }`}
              />
            ))}
          </div>
    ...
    <>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-gray-200 shadow-inner rounded-xl px-4 pl-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#0033a0] focus:ring-4 focus:ring-[#0033a0]/10 focus:bg-white hover:border-gray-300 transition-all duration-300 shadow-sm"
                  />
                </div>
              </div>
              ...
              {displayError && (
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-[#0033a0] to-[#15803d] text-white font-bold py-3.5 rounded-xl text-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:hover:translate-y-0 mt-4 shadow-md"
                >
            ...
            <p className="text-center text-sm text-gray-900/60 mt-4">
              ...
              <Link to="/signup" className="font-bold text-gray-900 hover:text-brand-blue transition-colors">
                Create Account
              </Link>
            </p>
              </>
      ...
      <div className="lg:hidden h-screen w-full bg-gray-100 font-sans flex flex-col items-center justify-center overflow-hidden px-4 py-2">
        ...
        <p className="text-center text-xs text-gray-500 mt-4">
          Don't have an account?{' '}
          <Link to="/signup" className="text-brand-blue font-bold hover:text-brand-blue/80 transition-colors">
            Create Account
          </Link>
        </p>
