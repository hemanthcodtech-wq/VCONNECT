  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-2xl border border-brand-blue/10 p-5 shadow-sm">
      ...
      <div className="bg-white rounded-2xl border border-brand-blue/10 p-5 shadow-sm">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl bg-[#FDF8F0] border border-brand-blue/5">
              <div>
