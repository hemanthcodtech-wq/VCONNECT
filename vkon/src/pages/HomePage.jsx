...
function StatsBanner() {
  const stats = [
    { icon: InstagramIcon, target: 12.6, decimals: 1, suffix: 'K', label: 'Instagram Family', color: '#E1306C', link: 'https://www.instagram.com/vconnect?igsh=c2llNGRzM2RpbHZ3&utm_source=qr' },
  ...
  return (
    <div className="animate-section md:px-8 mb-4 md:mb-10">
      {/* <div
        ...
        style={{
          background: 'linear-gradient(135deg, #0033a0 0%, #B81633 60%, #0033a0 100%)',
        ...
        {banners.length > 0 ? (
          ...
          <div className="relative w-full h-[180px] rounded-[20px] overflow-hidden shadow-xl bg-gradient-to-br from-[#0033a0] to-emerald-900">
            <div className="absolute inset-0 flex flex-col justify-center px-6 z-10 w-[65%]">
              ...
              <Link to="/category/all" className="bg-[#F29D38] text-white text-[10px] font-extrabold px-5 py-2 rounded-lg w-fit shadow-md hover:bg-white hover:text-[#0033a0] transition-colors">
                Shop Now
              </Link>
            </div>
              ...
              {banners.map((banner) => (
                <div key={banner.id} className="relative w-full h-full shrink-0">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex flex-col justify-center px-6 md:px-16">
                    ...
                    {(banner.link_url || banner.link_url === '') && (
                      <Link to={banner.link_url || "/category/all"} className="bg-white text-brand-blue text-xs md:text-base font-bold px-8 py-3 md:py-4 rounded-xl w-fit shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all">
                        SHOP NOW
                      </Link>
                    )}
                  </div>
          ...
          <div className="flex justify-center px-4 md:px-24 pt-2 md:pt-6 pb-2">
            <div className="relative w-full h-72 md:h-[360px] rounded-[24px] overflow-hidden shadow-2xl border border-[#0033a0]/10 bg-brand-beige group">
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-12 z-10 w-[70%]">
                <h2 className="text-[#0033a0] text-2xl md:text-4xl lg:text-[40px] font-bold mb-3 md:mb-4 leading-[1.2] font-serif tracking-wide drop-shadow-sm">
                  Premium Quality,<br />
<span className="text-[#F29D38] font-semibold">Delivered Daily</span>
                ...
                <Link to="/category/all" className="bg-[#0033a0] text-white text-[11px] md:text-xs font-bold px-6 py-3 md:px-8 md:py-3.5 rounded-xl w-fit shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all hover:bg-[#0a4722] tracking-wider uppercase">
                  SHOP NOW
                </Link>
              </div>
            </div>
        ...
        <div className="animate-section px-4 md:px-24 mb-10">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/category/all" className="text-sm font-semibold text-brand-orange flex items-center gap-1">View All <span className="text-lg leading-none">&rsaquo;</span></Link>
          </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link key={cat.id} to={`/category/${cat.id}`} className="group flex flex-col items-center gap-2">
                  <div className="w-[72px] h-[72px] md:w-32 md:h-32 rounded-full overflow-hidden shadow-sm hover:shadow-md hover:shadow-brand-orange/20 bg-white border-2 border-brand-blue/20 group-hover:border-brand-orange p-1 flex-shrink-0 transition-all duration-300 group-hover:scale-105">
                    <div className="w-full h-full rounded-full overflow-hidden bg-brand-beige flex items-center justify-center">
                      {cat.image_url ? (
        ...
        <div className="animate-section px-4 md:px-24 mb-12 flex justify-center mt-8">
          <div className="relative w-full h-56 md:h-[320px] rounded-[24px] overflow-hidden shadow-2xl shadow-brand-blue/10 border border-brand-blue/20 group">
            <div className="absolute inset-0 z-0">
              <img src="https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=1260&auto=format&fit=crop" alt="Special Discounts" className="w-full h-full object-cover object-center transition-transform duration-[2000ms] group-hover:scale-105 opacity-90" />
              <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/60 to-transparent z-10 pointer-events-none w-full md:w-[70%]"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent md:hidden z-10 pointer-events-none"></div>
            </div>
            
            <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12 pointer-events-none">
              <div className="max-w-[220px] md:max-w-md pointer-events-none">
                <div className="bg-brand-orange text-white text-[10px] md:text-xs font-black uppercase tracking-widest px-3 py-1 rounded-full w-fit mb-3 md:mb-4 shadow-lg pointer-events-auto">Today's Offers</div>
                <h2 className="text-white text-2xl md:text-5xl font-serif font-bold mb-2 md:mb-3 leading-tight drop-shadow-md">Special Discounts<br />on Bulk Orders</h2>
                <p className="text-gray-200 text-xs md:text-sm mb-5 md:mb-8 max-w-[90%] md:max-w-full drop-shadow-md leading-relaxed">Stock up on premium quality products and save more.</p>
              </div>
              <Link to="/category/all" className="bg-brand-blue text-white text-xs md:text-sm font-bold px-6 py-3 md:px-8 md:py-3.5 rounded-xl w-fit hover:bg-brand-orange hover:-translate-y-1 shadow-xl shadow-brand-blue/30 transition-all pointer-events-auto flex items-center gap-2">
                Explore Deals
            ...
            <div className="overflow-hidden w-full">
              ...
              >
                ...
                {[...reviews, ...reviews].map((rev, idx) => (
                  <div key={idx} className="w-[260px] md:w-[300px] p-6 shrink-0 bg-white border border-brand-blue/10 rounded-[20px] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between h-[200px]">
                    <div>
