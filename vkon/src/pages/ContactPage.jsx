...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!validate()) return;
    const text = `*New Message from VConnect Website*%0A%0A*Name:* ${encodeURIComponent(form.name)}%0A*Email:* ${encodeURIComponent(form.email || 'Not provided')}%0A*Subject:* ${encodeURIComponent(form.subject)}%0A%0A*Message:*%0A${encodeURIComponent(form.message)}`;
  ...
  const inputClass = (key) =>
    `w-full px-4 py-3 rounded-xl border bg-brand-beige focus:outline-none focus:ring-2 transition-shadow text-gray-900 placeholder:text-gray-900/30 ${
      errors[key] ? 'border-red-400 focus:ring-red-300' : 'border-brand-blue/10 focus:ring-brand-gold/40'
    }`;
  ...
  if (sent) return (
    <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
      ...
      <button onClick={() => { setSent(false); setForm({ name: '', email: '', subject: '', message: '' }); }}
        className="text-sm font-bold text-brand-blue underline mt-2">Send another message</button>
    </div>
  );
  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit}>
      ...
      <motion.button type="submit"
        ...
        whileTap={{ scale: 0.98 }}
        className="w-full bg-white text-brand-blue font-bold py-4 px-4 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all mt-2"
      >
        Send via WhatsApp
  ...
  return (
    <div className="bg-brand-beige min-h-screen pb-20 md:pb-12 font-sans">
      ...
      <div className="px-4 md:px-24 pt-12 md:pt-16 pb-10 md:pb-14">
        ...
        >
          <h4 className="text-brand-blue font-bold tracking-widest uppercase text-xs md:text-sm mb-3">Customer Support</h4>
          ...
          <div className="w-20 h-1.5 bg-brand-blue text-white rounded-full mb-6"></div>
      ...
      <div className="px-4 md:px-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
          ...
          >
            {/* Location */}
            <div className="bg-white border border-brand-blue/10 rounded-2xl p-6 flex items-start gap-5 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div className="bg-white border border-brand-blue/10 rounded-2xl p-6 flex items-start gap-5 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-900/70 text-sm"></p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm flex-grow flex flex-col justify-between">
              <div>
                <h3 className="font-bold text-brand-blue text-lg mb-4">Follow Our Store</h3>
                <div className="flex items-center gap-4">
                  <a href="https://www.instagram.com/vconnect?igsh=c2llNGRzM2RpbHZ3&utm_source=qr" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-white border border-brand-blue/20 flex items-center justify-center text-brand-blue shadow-sm hover:scale-105 hover:shadow-md transition-all">
                  ...
                  <a href="https://youtube.com/@VConnect7471?si=3sOLJa_Rvzxhgx7V" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-white border border-brand-blue/20 flex items-center justify-center text-brand-blue shadow-sm hover:scale-105 hover:shadow-md transition-all">
          ...
          <motion.div
            ...
            className="bg-white border border-brand-blue/10 rounded-[24px] shadow-lg p-8 md:p-10 relative overflow-hidden"
          >
...
<ContactForm />
      ...
      <div className="px-4 md:px-24 py-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-brand-blue rounded-[24px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl"
        >
      ...
      <div id="faq-section" className="bg-white py-16">
        <div className="px-4 md:px-24">
          <div className="text-center mb-12">
            ...
            <div className="w-16 h-1 bg-brand-blue text-white mx-auto rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="bg-brand-beige border border-brand-blue/10 rounded-2xl p-6 hover:shadow-md transition-shadow"
              >
                <div className="flex items-start gap-3">
                  <div className="w-7 h-7 rounded-full bg-white flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-brand-blue text-xs font-bold">Q</span>
                  </div>
                  <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-white border border-brand-blue/10 rounded-2xl p-6 text-center shadow-sm hover:shadow-lg transition-shadow"
            >
              <p className="text-3xl md:text-4xl font-serif font-bold text-brand-blue mb-2">
