    ...
    subject: 'Your OTP for VConnect Signup',
      html: `
        <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;padding:24px;border:2px solid #0033a0;border-radius:12px;background-color:#ffffff;">
          ...
          <div style="font-size:36px;font-weight:bold;color:#0033a0;letter-spacing:8px;text-align:center;padding:16px;background:#f0fdf4;border:1px dashed #0033a0;border-radius:8px;margin:20px 0;">
            ${otp}
          </div>
          <p style="color:#6b7280;font-size:13px;text-align:center;">This OTP is valid for 10 minutes. Do not share it with anyone.</p>
        </div>
      `,
  });
}
...
router.post('/orders', authMiddleware, async (req, res) => {
  const { items, address, total, coupon_code, payment_method, order_type, razorpay_order_id, razorpay_payment_id, razorpay_signature, discount_amount, shipping_fee, tax_amount, m_coins_used, store_id } = req.body;
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;padding:24px;border:2px solid #0033a0;border-radius:12px;background-color:#ffffff;">
          ...
          <p style="color:#333;font-size:16px;">Your OTP to reset your password is:</p>
          <div style="font-size:36px;font-weight:bold;color:#0033a0;letter-spacing:8px;text-align:center;padding:16px;background:#f0fdf4;border:1px dashed #0033a0;border-radius:8px;margin:20px 0;">
            ${otp}
          </div>
          <p style="color:#6b7280;font-size:13px;text-align:center;">Valid for 10 minutes. Do not share it with anyone.</p>
        </div>
      `,
    });
